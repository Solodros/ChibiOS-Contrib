...
PLATFORMSRC_CONTRIB += $(CHIBIOS)/os/hal/ports/common/ARMCMx/nvic.c \
                       $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F435xx/hal_lld.c \
			           $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F435xx/at32_isr.c \
                       $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F435xx/hal_efl_lld.c

# Required include directories.
PLATFORMINC_CONTRIB += $(CHIBIOS)/os/hal/ports/common/ARMCMx \
               $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/AT32F435xx
...
include $(CHIBIOS_CONTRIB)/os/hal/ports/AT32/LLD/SDIOv2/driver.mk
