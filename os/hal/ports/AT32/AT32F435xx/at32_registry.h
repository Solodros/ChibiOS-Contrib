...
/**
 * @file    AT32F435xx/at32_registry.h
 * @brief   AT32F435xx capabilities registry.
 *
 * @addtogroup HAL
 * @{
 */
...
#if defined(AT32F435Cx) || defined(__DOXYGEN__)
/**
...
#if defined(AT32F435Rx) || defined(AT32F437Rx) || defined(__DOXYGEN__)
/**
...
#if defined(AT32F435Vx) || defined(AT32F437Vx) || defined(__DOXYGEN__)
/**
...
#if defined(AT32F435Zx) || defined(AT32F437Zx) || defined(__DOXYGEN__)
/**
