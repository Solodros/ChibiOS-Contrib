 ...
 */
#if !defined(AT32_USB_USE_USB1) || defined(__DOXYGEN__)
#define AT32_USB_USE_USB1                  FALSE
#endif

/**
 * @brief   Enables the USB device low power mode on suspend.
 */
#if !defined(AT32_USB_LOW_POWER_ON_SUSPEND) || defined(__DOXYGEN__)
 ...
 * @brief   Enables the USB device low power mode on suspend.
 */
#if !defined(AT32_USB_USB1_IRQ_REMAP) || defined(__DOXYGEN__)
 ...
 */
#if (!defined(AT32_USB_USB1_HP_IRQ_PRIORITY) &&                           \
     (AT32_USB1_HP_NUMBER != AT32_USB1_LP_NUMBER)) || defined(__DOXYGEN__)
 ...
 * @brief   USB1 interrupt priority level setting.
 */
#if !defined(AT32_USB_USB1_LP_IRQ_PRIORITY) || defined(__DOXYGEN__)
 ...
 */
#if !defined(AT32_USB_USE_ISOCHRONOUS) || defined(__DOXYGEN__)
#define AT32_USB_USE_ISOCHRONOUS           FALSE
#endif
 ...
 */
#if !defined(AT32_USB_USE_FAST_COPY) || defined(__DOXYGEN__)
#define AT32_USB_USE_FAST_COPY             FALSE
#endif
...
#if AT32_USB_USE_USB1 && !AT32_HAS_USB
...
#if !defined(AT32_USBCLK)
#error "AT32_USBCLK not defined"
#endif

#if AT32_USB_USE_USB1 &&                                                   \
    (AT32_USB1_HP_NUMBER != AT32_USB1_LP_NUMBER) &&                       \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_USB_USB1_HP_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB HP"
#endif

#if AT32_USB_USE_USB1 &&                                                   \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_USB_USB1_LP_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB LP"
#endif

#if !defined(AT32_USB1_HP_HANDLER)
#error "AT32_USB1_HP_HANDLER not defined"
#endif

#if !defined(AT32_USB1_HP_NUMBER)
#error "AT32_USB1_HP_NUMBER not defined"
#endif

#if !defined(AT32_USB1_LP_HANDLER)
#error "AT32_USB1_LP_HANDLER not defined"
#endif

#if !defined(AT32_USB1_LP_NUMBER)
#error "AT32_USB1_LP_NUMBER not defined"
#endif

#if AT32_USB_USB1_IRQ_REMAP
#if AT32_USB_USE_USB1 &&                                                   \
    (AT32_USB1_MAPHP_NUMBER != AT32_USB1_MAPLP_NUMBER) &&                       \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_USB_USB1_MAPHP_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB MAPHP"
#endif

#if AT32_USB_USE_USB1 &&                                                   \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_USB_USB1_MAPLP_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to USB MAPLP"
#endif

#if !defined(AT32_USB1_MAPHP_HANDLER)
#error "AT32_USB1_MAPHP_HANDLER not defined"
#endif

#if !defined(AT32_USB1_MAPHP_NUMBER)
#error "AT32_USB1_MAPHP_NUMBER not defined"
#endif

#if !defined(AT32_USB1_MAPLP_HANDLER)
#error "AT32_USB1_MAPLP_HANDLER not defined"
#endif

#if !defined(AT32_USB1_MAPLP_NUMBER)
#error "AT32_USB1_MAPLP_NUMBER not defined"
#endif
#endif
...
#if (AT32_USB_48MHZ_DELTA < 0) || (AT32_USB_48MHZ_DELTA > 250000)
#error "invalid AT32_USB_48MHZ_DELTA setting, it must not exceed 250000"
#endif
 ...
 * @notapi
 */
#define usb_lld_get_frame_number(usbp) (AT32_USB->FNR & FNR_FN_MASK)
 ...
 */
#if !defined(usb_lld_connect_bus)
#define usb_lld_connect_bus(usbp) (AT32_USB->CFG &= ~USBFS_CFG_PUO)
#endif
