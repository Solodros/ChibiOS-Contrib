...
void at32_clock_init(void) {
  ...
  /* PLL activation.*/
  CRM->CFG |= AT32_PLLMUL | AT32_PLLXTPRE | AT32_PLLSRC;
  ...
  /* Clock settings.*/
#if AT32_HAS_OTG1
  CRM->CFG = (AT32_MCOSEL & AT32_MCOSEL_CFG_MASK)    | AT32_USBPRE | AT32_PLLMUL | AT32_PLLXTPRE |
             AT32_PLLSRC | AT32_ADCPRE | AT32_PPRE2  | AT32_PPRE1  | AT32_HPRE;
  CRM->MISC1 |= (AT32_MCOSEL & AT32_MCOSEL_MISC_MASK) >> 11;
#else
  CRM->CFG = (AT32_MCOSEL & AT32_MCOSEL_CFG_MASK)    |               AT32_PLLMUL | AT32_PLLXTPRE |
             AT32_PLLSRC | AT32_ADCPRE | AT32_PPRE2  | AT32_PPRE1  | AT32_HPRE;
  CRM->MISC1 |= (AT32_MCOSEL & AT32_MCOSEL_MISC_MASK) >> 11;
#endif
  ...
  CRM->CFG |= AT32_SW;
  while ((CRM->CFG & CRM_CFG_SCLKSTS) != (AT32_SW << 2)); /* Waits selection complete.    */
#endif
