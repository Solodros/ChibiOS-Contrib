...
#endif
#if AT32_HAS_GPIOG
  {VAL_GPIOG_MODE, VAL_GPIOG_OUTPUT, VAL_GPIOG_ODRVR, VAL_GPIOG_PULL,
   VAL_GPIOG_ODT,   VAL_GPIOG_MUXL,   VAL_GPIOG_MUXH, VAL_GPIOG_HDRV},
#endif
#if AT32_HAS_GPIOH
  {VAL_GPIOH_MODE, VAL_GPIOH_OUTPUT, VAL_GPIOH_ODRVR, VAL_GPIOH_PULL,
...
#endif
#if AT32_HAS_GPIOE
  gpio_init_lld(GPIOE, &gpio_default_config.PEData);
#endif
#if AT32_HAS_GPIOF
  gpio_init_lld(GPIOF, &gpio_default_config.PFData);
#endif
#if AT32_HAS_GPIOG
  gpio_init_lld(GPIOG, &gpio_default_config.PGData);
#endif
#if AT32_HAS_GPIOH
  gpio_init_lld(GPIOH, &gpio_default_config.PHData);
#endif
}
/*===========================================================================*/
