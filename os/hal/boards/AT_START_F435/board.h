 ...
 */
#define VAL_GPIOF_MODE              (PIN_MODE_INPUT(GPIOF_PIN0) |            \
...
#define VAL_GPIOF_OUTPUT            (PIN_OUTPUT_PUSHPULL(GPIOF_PIN0) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN1) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN2) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN3) |       \
                                     ...
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN12) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN13) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN14) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOF_PIN15))
...
#define VAL_GPIOF_PULL              (PIN_PULL_NONE(GPIOF_PIN0) |             \
                                     PIN_PULL_NONE(GPIOF_PIN1) |             \
                                     PIN_PULL_NONE(GPIOF_PIN2) |             \
                                     PIN_PULL_NONE(GPIOF_PIN3) |             \
                                     ...
                                     PIN_PULL_NONE(GPIOF_PIN12) |            \
                                     PIN_PULL_NONE(GPIOF_PIN13) |            \
                                     PIN_PULL_NONE(GPIOF_PIN14) |            \
                                     PIN_PULL_NONE(GPIOF_PIN15))
...
#define VAL_GPIOF_HDRV              (PIN_HDRV_NOTACTIVE(GPIOF_PIN0) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN1) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN2) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN3) |        \
                                     ...
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN12) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN13) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN14) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOF_PIN15))
 ...
 */
#define VAL_GPIOG_MODE              (PIN_MODE_INPUT(GPIOG_PIN0) |            \
...
#define VAL_GPIOG_OUTPUT            (PIN_OUTPUT_PUSHPULL(GPIOG_PIN0) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN1) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN2) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN3) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN4) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN5) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN6) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN7) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN8) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN9) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN10) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN11) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN12) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN13) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN14) |      \
                                     PIN_OUTPUT_PUSHPULL(GPIOG_PIN15))
...
#define VAL_GPIOG_PULL              (PIN_PULL_NONE(GPIOG_PIN0) |             \
                                     PIN_PULL_NONE(GPIOG_PIN1) |             \
                                     PIN_PULL_NONE(GPIOG_PIN2) |             \
                                     PIN_PULL_NONE(GPIOG_PIN3) |             \
                                     PIN_PULL_NONE(GPIOG_PIN4) |             \
                                     PIN_PULL_NONE(GPIOG_PIN5) |             \
                                     PIN_PULL_NONE(GPIOG_PIN6) |             \
                                     PIN_PULL_NONE(GPIOG_PIN7) |             \
                                     PIN_PULL_NONE(GPIOG_PIN8) |             \
                                     PIN_PULL_NONE(GPIOG_PIN9) |             \
                                     PIN_PULL_NONE(GPIOG_PIN10) |            \
                                     PIN_PULL_NONE(GPIOG_PIN11) |            \
                                     PIN_PULL_NONE(GPIOG_PIN12) |            \
                                     PIN_PULL_NONE(GPIOG_PIN13) |            \
                                     PIN_PULL_NONE(GPIOG_PIN14) |            \
                                     PIN_PULL_NONE(GPIOG_PIN15))
...
#define VAL_GPIOG_HDRV              (PIN_HDRV_NOTACTIVE(GPIOG_PIN0) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN1) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN2) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN3) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN4) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN5) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN6) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN7) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN8) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN9) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN10) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN11) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN12) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN13) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN14) |       \
                                     PIN_HDRV_NOTACTIVE(GPIOG_PIN15))
 ...
 */
#define VAL_GPIOH_MODE              (PIN_MODE_INPUT(GPIOH_PIN0) |            \
...
#define VAL_GPIOH_OUTPUT            (PIN_OUTPUT_PUSHPULL(GPIOH_PIN0) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOH_PIN1) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOH_PIN2) |       \
                                     PIN_OUTPUT_PUSHPULL(GPIOH_PIN3))
...
#define VAL_GPIOH_PULL              (PIN_PULL_NONE(GPIOH_PIN0) |             \
                                     PIN_PULL_NONE(GPIOH_PIN1) |             \
                                     PIN_PULL_NONE(GPIOH_PIN2) |             \
                                     PIN_PULL_NONE(GPIOH_PIN3))
...
#define VAL_GPIOH_HDRV              (PIN_HDRV_NOTACTIVE(GPIOH_PIN0) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOH_PIN1) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOH_PIN2) |        \
                                     PIN_HDRV_NOTACTIVE(GPIOH_PIN3))
